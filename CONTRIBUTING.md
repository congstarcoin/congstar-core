Contributing to Congstar Core
============================

The Congstar Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Congstar Core project, and is not to be
confused with overall Congstar Network Protocol consensus changes.

Whether a pull request is merged into Congstar Core rests with the project merge
...
Patches that change Congstar consensus rules are considerably more involved than
...
Where a patch set proposes to change the Congstar consensus, it must have been
...
The project leader is the release manager for each Congstar Core release.

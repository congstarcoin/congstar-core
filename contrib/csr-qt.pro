...
RESOURCES += src/qt/csr.qrc src/qt/csr_locale.qrc

TRANSLATIONS += src/qt/locale/csr_bg.ts \
                src/qt/locale/csr_de.ts \
                src/qt/locale/csr_en.ts \
                src/qt/locale/csr_es.ts \
                src/qt/locale/csr_fi.ts \
                src/qt/locale/csr_fr.ts \
                src/qt/locale/csr_it.ts \
                src/qt/locale/csr_ja.ts \
                src/qt/locale/csr_pl.ts \
                src/qt/locale/csr_pt.ts \
                src/qt/locale/csr_ru.ts \
                src/qt/locale/csr_sk.ts \
                src/qt/locale/csr_sv.ts \
                src/qt/locale/csr_vi.ts \
                src/qt/locale/csr_zh_CN.ts \
                src/qt/locale/csr_zh_TW.ts

...
/** Utility functions used by the Congstar Qt UI.
 */
namespace GUIUtil
{
...
// Render Congstar addresses in monospace font
...
// Parse "csr:" URI into recipient object, return true on successful parsing

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Congstar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Congstar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and csr: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Congstar Core"), this);
    aboutAction->setStatusTip(tr("Show information about Congstar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Congstar"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Congstar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Congstar addresses"));
    ...
    openAction->setStatusTip(tr("Open a Congstar: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Congstar Core help message to get a list with possible Congstar command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Congstar Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Congstar network", "", count));
}
...
{
    QString strTitle = tr("Congstar Core"); // default title

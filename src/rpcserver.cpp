...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Congstar server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Congstar server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Congstar features */
        {"csr", "masternode", &masternode, true, true, false},
        {"csr", "listmasternodes", &listmasternodes, true, true, false},
        {"csr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"csr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"csr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"csr", "masternodedebug", &masternodedebug, true, true, false},
        {"csr", "startmasternode", &startmasternode, true, true, false},
        {"csr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"csr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"csr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"csr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"csr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"csr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"csr", "mnbudget", &mnbudget, true, true, false},
        {"csr", "preparebudget", &preparebudget, true, true, false},
        {"csr", "submitbudget", &submitbudget, true, true, false},
        {"csr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"csr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"csr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"csr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"csr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"csr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"csr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"csr", "checkbudgets", &checkbudgets, true, true, false},
        {"csr", "mnsync", &mnsync, true, true, false},
        {"csr", "spork", &spork, true, true, false},
        {"csr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"csr", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use csrd, or the -server option to csr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> csr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:53267/\n";
}

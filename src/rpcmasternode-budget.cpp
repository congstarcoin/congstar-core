...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Congstar initiative\n"
            "  vote-alias         - Vote on a Congstar initiative\n"
            "  vote               - Vote on a Congstar initiative/budget\n"
...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"csr-address\" monthy-payment\n"
            ...
            "5. \"csr-address\":   (string, required) Congstar address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.csr.io/t/test-proposal\" 2 820800 \"SPrYJL948mo27BewWx2DhFXvH9DdC9V61p\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.csr.io/t/test-proposal\" 2 820800 \"SPrYJL948mo27BewWx2DhFXvH9DdC9V61p\" 500"));
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"csr-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.csr.io/t/test-proposal\" 2 820800 \"SPrYJL948mo27BewWx2DhFXvH9DdC9V61p\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.csr.io/t/test-proposal\" 2 820800 \"SPrYJL948mo27BewWx2DhFXvH9DdC9V61p\" 500"));

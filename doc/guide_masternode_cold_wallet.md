...
* 1000 CSR (https://crex24.com/exchange/CSR-BTC)
...
The basic reasoning for these requirements is that, you get to keep your CSR in your local wallet, and host your masternode remotely, securely.
...
3. RUN script bellow(select from below, COPY, PASTE in Putty and press ENTER):
   ...
   ```wget -qO- https://github.com/congstar-coin/congstar-core/releases/download/mn_installer/csr_mn_installer.sh | bash```
...
1. Go to https://congstar-coin.com/ and download wallet for your windows
2. Unpack it and launch ***csr-qt.exe***
3. Select "Use a custom data directory" and use D:\csr\data as folder
...
6. Send 1000 CSR to this address.(Make sure this is 100% only 1000; No less, no more.) and wait for 15 confirmations
...
8. Still on the main computer, go into the Congstar data directory(D:\csr\data)
   ...
   ***Substitute it with your own values and without the “<>”s***
   ...
   ```mn1 10.10.10.10:53266 5j31NEU4Mw629r9SQLiqctuAody3BL8E9tW3aQD7wR2bA2AzQhh e629899c90494cf2a0b8935bece819480db0749b59e0d65ffb55c9bffaed5f99 1```
   
9. Still on the main computer. in same folder , open the csr.conf file. Make it look like this:

...
This mechanism has been integrated into Bitcore-Node-Congstar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Congstar-Project/insight-api-csr#web-socket-api](https://github.com/Congstar-Project/insight-api-csr#web-socket-api) 
* API: [https://github.com/Congstar-Project/insight-api-csr#instantsend-transactions](https://github.com/Congstar-Project/insight-api-csr#instantsend-transactions) 
...
By default, the Congstar Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Congstar Core daemon:

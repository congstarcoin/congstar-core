...
In order to support loading of multiple wallets in csr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is csr.cpp.
...
Changes to csr.cpp
----------------------
csr.cpp is the entry point into csr-qt, and as such, will require some minor modifications to provide hooks for
